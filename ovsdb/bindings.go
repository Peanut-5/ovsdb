...
func NativeTypeFromAtomic(basicType string) reflect.Type {
	...
	case TypeUUID:
		return strType
	default:
		fmt.Println("Unknown basic type %s basicType")
		return nil
	}
}
...
func NativeType(column *ColumnSchema) reflect.Type {
	...
	default:
		fmt.Println("unknown extended type %s", column.Type)
		return nil
	}
}
...
func OvsToNativeAtomic(basicType string, ovsElem interface{}) (interface{}, error) {
	...
	default:
		fmt.Println("unknown atomic type %s", basicType)
		return nil, nil
	}
}
...
func NativeToOvs(column *ColumnSchema, rawElem interface{}) (interface{}, error) {
	...
	default:
		return nil, errors.New(fmt.Sprintf("Unknown Type: %v", column.Type))
	}
}
